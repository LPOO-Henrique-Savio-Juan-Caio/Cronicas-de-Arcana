...
public class CemiterioGui {
    ...
    public JPanel createCemiterioPanel(Jogador jogador, Jogador jogadorRival, int initialX, int initialY, ImageIcon imagem){
        ...
        cardButton.setIcon(imagem);
        cardButton.setBorderPainted(false);
        cardButton.setMargin(new Insets(0, 0, 0, 0));
        cardButton.setContentAreaFilled(false);
        cardButton.setFocusPainted(false);
        cardButton.setRolloverEnabled(false);
        ...
        cardButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                cemiterioDialog.setSize(300, 400);
